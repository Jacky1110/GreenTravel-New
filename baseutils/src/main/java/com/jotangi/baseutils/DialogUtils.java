...
public class DialogUtils {
    ...
    public static View createDialogView(int layoutid, ViewGroup viewGroup, String title, String message, String bnlabel, @NonNull final OneButtonClickListener listener) {
...
//        bnText.setText(bnlabel);
    ...
    public static View create2ButtonAndCancelDialogView(
            ...
            String bn1label,
            String bn2label,
            @NonNull final TwoButtonAndCancelClickListener listener
    ) {
        View dialogView = LayoutInflater.from(viewGroup.getContext()).inflate(layoutid, viewGroup, false);
    ...
    public static void showMyDialog(ViewGroup viewGroup, String title, String message, String btnlabel, @NonNull final OneButtonClickListener listener) {
   ...
   public static void showMyDialog(ViewGroup viewGroup, int titleid, int messageid, int btnlabelid, @NonNull final OneButtonClickListener listener) {
    ...
    public static void showMyDialog(ViewGroup viewGroup, int titleid, int messageid, String parm1, int btnlabelid, @NonNull final OneButtonClickListener listener) {
        Context context = viewGroup.getContext();
        String title = (titleid > 0) ? context.getString(titleid) : "";
    ...
    public static void show2ButtonAndCancelDialog(
        ...
        View dialogView = create2ButtonAndCancelDialogView(
                R.layout.dialog_two_button_with_cancel_vertical,
                viewGroup,
                title,
                message,
                bn1label,
    ...
    public static void show2ButtonAndCancelDialog(
        ...
        String title = (titleid > 0) ? context.getString(titleid) : "";
        String message = (messageid > 0) ? context.getString(messageid) : "";
        String bn1label = (bn1labelid > 0) ? context.getString(bn1labelid) : context.getString(R.string.button_confirm);
