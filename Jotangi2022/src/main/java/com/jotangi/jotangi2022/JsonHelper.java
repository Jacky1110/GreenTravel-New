...
public class JsonHelper {
    ...
    protected com.jotangi.jotangi2022.Logger logger;

    public JsonHelper(Context context, com.jotangi.jotangi2022.Logger logger) {
    ...
    public InputStream loadInputStreamFromAssetFile(Context context, String fileName){
        ...
        try {
            ...
            ex.printStackTrace();
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "loadInputStreamFromAssetFile(), ex="+ex.toString());
        }
        return null;
    }
    ...
    public JSONObject loadJsonFromAssetFile(Context context, String path){
        ...
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "loadJsonFromAssetFile(), ex="+ex.toString());
            return null;
        }
        return jo;
    }
    ...
    public JSONArray loadJsonArrayFromAssetFile(Context context, String path){
        ...
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "loadJsonArrayFromAssetFile(), ex="+ex.toString());
            return null;
        }
    }
    ...
    public String loadContentFromInputStream(InputStream is) {
        ...
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "loadContentFromInputStream(), ex="+ex.toString());
            return null;
        }
        return content;
    }
    ...
    public JSONObject loadJsonFromInputStream(InputStream is) {
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "loadJsonFromInputStream(), ex="+ex.toString());
        }
        return null;
    }
    ...
    public JSONObject loadJsonFromFile(File file) {
        ...
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "loadJsonFromFile(), ex="+ex.toString());
        }
        return null;
    }
    ...
    public JSONArray loadJsonArrayFromInputStream(InputStream is) {
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "loadJsonArrayFromInputStream(), ex="+ex.toString());
        }
        return null;
    }
    ...
    public JSONArray loadJsonArrayFromFile(File file) {
        ...
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "loadJsonArrayFromFile(), ex="+ex.toString());
        }
        return null;
    }
    ...
    public void closeInputStream(InputStream is) {
        if (is != null) {
            try {
                ...
                writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "closeInputStream(), ex="+ex.toString());
            }
        }
    }
    ...
    public void closeInputStreamReader(InputStreamReader isr) {
        if (isr != null) {
            try {
                ...
                writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "closeInputStreamReader(), ex="+ex.toString());
            }
        }
    }
    ...
    public boolean writeStringToFile(String data, File file) {
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "writeStringToFile(), ex="+ex.toString());
        }
        return false;
    }
    ...
    public boolean writeStringArrayToJsonFile(String[] datas, File file) {
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "writeStringArrayToJsonFile(), ex="+ex.toString());
            return false;
        }
    }
    ...
    public String[] readStringArrayFromJsonArray(JSONArray ja) {
        if (ja != null) {
            try {
                ...
                writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "readStringListFromJsonArray(), ex=" + ex.toString());
            }
        }
        return null;
    }
    ...
    public List<String> readStringListFromJsonString(String data) {
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "readStringListFromJsonString(), ex="+ex.toString());
        }
        return null;
    }
    ...
    public List<Integer> readIntegerListFromJsonArray(JSONArray ja) {
        if (ja != null) {
            try {
                ...
                writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "readIntegerListFromJsonArray(), ex=" + ex.toString());
            }
        }
        return null;
    }
    ...
    public int[] readIntegerArrayFromJsonArray(JSONArray ja) {
        if (ja != null) {
            try {
                ...
                writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "readIntegerArrayFromJsonArray(), ex=" + ex.toString());
            }
        }
        return null;
    }
    ...
    public Map<String, String> readMapStringStringFromJson(JSONObject jo) {
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "readMapStringStringFromJson() , ex="+ex.toString());
        }
        return null;
    }
    ...
    public Map<String, Integer> readMapStringIntegerFromJson(JSONObject jo) {
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "readMapStringIntegerFromJson() , ex="+ex.toString());
            return null;
        }
    }
    ...
    public boolean writeObjectToJsonFile(Object obj, File file) {
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "writeObjectToJsonFile(), ex="+ex.toString());
        }
        return false;
    }
    ...
    public String objectToJsonString(Object data, boolean pretty) {
        try {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "objectToJsonString(), ex="+ex.toString());
            ex.printStackTrace();
            return null;
        }
    }
    ...
    public boolean hasKeys(JSONObject jo, String[] keys) {
        for (String s : keys) {
            ...
            writeLog(com.jotangi.jotangi2022.Logger.LEVEL_ERROR, "hasKeys(), nokey: "+s);
            return false;
        }
        return true;
    }
