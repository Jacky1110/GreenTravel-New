...
public class RingProgrseeBar extends View {
    ...
    private static final float DEFAULT_LINE_WIDTH = 40.0f;
...
//	#8C8C8C
        private static final String COLOR_FFF2A670 = "#8C8C8C";
    private static final String COLOR_FFD3D3D5 = "#FAFAFA";
    ...
    public RingProgrseeBar(Context context) {
        this(context, null);
    }

    public RingProgrseeBar(Context context, AttributeSet attrs) {
        super(context, attrs);
