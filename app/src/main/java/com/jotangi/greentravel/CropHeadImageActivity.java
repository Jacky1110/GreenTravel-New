...
import com.jotangi.jotangi2022.Bitmaputils;
...
public class CropHeadImageActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        Log.d(TAG, "onResume()");
        if (bitmap == null) {
            DialogUtils.show2ButtonAndCancelDialog((ViewGroup) vwMask.getRootView(), 0, R.string.msg_image_from, R.string.camera, R.string.gallery, new DialogUtils.TwoButtonAndCancelClickListener() {
                @Override
